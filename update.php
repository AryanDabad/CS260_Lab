        ...
        if(!endsWith($email, '@iitp.ac.in')){
            ...
            if(strlen($new_pass1) < 8 || !$number || !$uppercase || !$lowercase || !$specialChars) {
                ...
                if($result){
                    ...
                    echo '<script language="javascript">window.location = "http://localhost/aryan/logout.php";</script>';
                }
                else{
...
<body>
	...
	<form action="" method="post">
		...
		<input type="submit"  value = 'Update Details' name = "Submit" style="background-color:#FC7300;"> <br>
        <p>
